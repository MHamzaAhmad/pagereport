/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 7d1efe5680764532f9139be928bac443)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		CHECKOUT_SUCCESS_URL: "http://localhost:5173/reports/{reportId}?purchase=success";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ALLOWED_ORIGINS" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "POLAR_PRODUCT_ID" | "POLAR_SERVER" | "CHECKOUT_SUCCESS_URL" | "PAGESPEED_API_KEY" | "FIRECRAWL_API_KEY" | "TRUSTMRR_API_KEY">> {}
}
